...
def main(cfg_file):
    ...
    # Policy param
    # Mapping of activation function names to actual PyTorch classes
    ...
    # Get the activation function from the config
    activation_fn_name = params['policy_kwargs']['activation_fn']
    activation_fn = activation_fn_mapping.get(activation_fn_name)

    # Create the model using the policy_kwargs from the config
    policy_kwargs = {
